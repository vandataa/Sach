                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($authors as $key => $auth)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>
                                                        <img src="@if ($auth->author_image) {{ asset('storage/images/' . $auth->author_image) }} @else https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg @endif"
                                                            style="width: 50px" alt="">
                                                    </td>
                                                    <td><a href="{{ route('author.detail', $auth->id) }}">{{ $auth->name_author }}</a></td>
                                            ...
                                            <div class="row">
                                               @if($auth->deleted_at)
                                                    <a href="{{route('authors.restore', $auth->id)}}">Khôi phục</a>
                                                @else
                                                    <div class="col-6">
                                                        <a href="{{  route('authors.edit', $auth->id) }}">
                                                    ...
                                                    <div class="col-6">
                                                        <a>
                                                            <form action="{{ route('authors.delete', $auth->id) }}"
                                                                  method="post">
                                                                @csrf
